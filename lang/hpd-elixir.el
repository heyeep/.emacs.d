...
(use-package alchemist
  ...
  ;; Erlang synergy
  (defun hpd/elixir-erlang-pop-back ()
  ...
  (defun hpd/alchemist-erlang-mode-hook ()
    (define-key erlang-mode-map (kbd "M-,") 'hpd/elixir-erlang-pop-back))

  (add-hook 'erlang-mode-hook 'hpd/alchemist-erlang-mode-hook))
